...
class App extends React.Component {
    constructor(props) {
        ...
        this.handleSelectedNodeChange =
            this.handleSelectedNodeChange.bind(this);
        ...
        this.handleCopyURLToClipboard =
            this.handleCopyURLToClipboard.bind(this);
    ...
    handleMoveNode(node, parent) {
        ...
        result.then((response) => {
            ...
            this.showToastMessage(
                toast.success,
                `Moved ${node.name} to ${parent.name}`
            );
        });
    }
